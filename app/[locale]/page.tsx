...
import { ArrowRight, Ship, Plane, Truck, FileCheck, Warehouse, Package, ChevronRight } from "lucide-react";
import { Button } from "@/components/ui/button";

const serviceImages = [
  { key: "sea",        icon: Ship,      img: "https://images.unsplash.com/photo-1578575437130-527eed3abbec?w=800&q=80" },
  { key: "air",        icon: Plane,     img: "https://images.unsplash.com/photo-1436491865332-7a61a109cc05?w=800&q=80" },
  { key: "road",       icon: Truck,     img: "https://images.unsplash.com/photo-1601584115197-04ecc0da31d7?w=800&q=80" },
  { key: "customs",    icon: FileCheck, img: "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=800&q=80" },
  { key: "warehousing",icon: Warehouse, img: "https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=800&q=80" },
  { key: "doorToDoor", icon: Package,   img: "https://images.unsplash.com/photo-1566576721346-d4a3b4eaeb55?w=800&q=80" },
];
...
const newsItems = [
  {
    ...
    date: "March 2024",
    title: "Dedicated Weekly Service: Algiers ↔ Valencia",
    img: "https://images.unsplash.com/photo-1595246140625-573b715d11dc?w=700&q=80",
  },
  {
    category: "Industry",
    date: "January 2024",
    title: "Algeria–EU Trade: Trends & Opportunities in 2024",
    img: "https://images.unsplash.com/photo-1494412651409-8963ce7935a7?w=700&q=80",
  },
  {
    category: "Regulatory",
    date: "November 2023",
    title: "Key Changes to Algerian Import Regulations",
  ...
  return (
    <>
      ...
      <section className="py-20 bg-[#050c1f]">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-4 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 gap-3">
